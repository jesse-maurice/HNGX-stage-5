            ...
            <a href="/">
              <div className="icon-7-1-parent">
                <img
                  className="icon-7-1"
                  alt=""
                  src="/icons/icons-pack/android-chrome-192x192.png"
                />
        ...
        <div className="frame-container">
          ...
          <div className="login-sso1-parent">
            <button className="login-sso1">
              <img
                ...
                alt=""
                src="/icons/help_assets/Google svg.svg"
              />
              <div className="continue-with-google w-color">
          ...
          <div className="vector-parent">
            <img
              ...
              alt=""
              src="/icons/help_assets/Line 18.svg"
            />
            ...
            <div className="login-inputfield">
              <div className="baseinputfield2">
                ...
                <div className="user-container">
                  ...
                  <div className="input-text-here2">
                    <input
                      type="email"
